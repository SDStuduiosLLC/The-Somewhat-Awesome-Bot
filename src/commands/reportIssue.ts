import { Client, EmbedBuilder, CommandInteraction, Guild, SlashCommandBuilder } from "discord.js";
...
module.exports = {
    ...
    async execute(ctx: CommandInteraction, client: Client) {
        ...
        try {
            ctx.reply({ content:`Bug Report Submitted!\n\nPlease don't harrass anyone from SDStudios or the people keeping this instance up and running.`, ephemeral:true })
        } catch (e:any) {
